...
DEFAULT_TF1_CPU_IMAGE = "mackrorysd/environments:py-3.7-pytorch-1.7-tf-1.15-cpu-0.16.2"
DEFAULT_TF2_CPU_IMAGE = (
    "mackrorysd/environments:py-3.7-pytorch-1.9-lightning-1.3-tf-2.4-cpu-0.16.2"
)
DEFAULT_TF1_GPU_IMAGE = "mackrorysd/environments:cuda-10.2-pytorch-1.7-tf-1.15-gpu-0.16.2"
DEFAULT_TF2_GPU_IMAGE = (
    "mackrorysd/environments:cuda-11.1-pytorch-1.9-lightning-1.3-tf-2.4-gpu-0.16.2"
)
